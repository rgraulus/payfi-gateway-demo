#!/usr/bin/env node
/**
 * PR #214 — Phase 3 production release CRP fulfill client adapter result consumption receipt decode dry-run audit.
 *
 * This harness proves the Gateway observes the receipt material handling gate, then exposes
 * a receipt decode dry-run audit that blocks decoding, parsing, or verifying receipt material.
 *
 ...
 * - switch ON  + dry-run ON  + result consumption ON  => receipt decode dry-run audit observed as blocked and non-decoding
...
const LABEL = "phase3:production-release-crp-fulfill-client-adapter-result-consumption-receipt-decode-dry-run-audit-test";
  ...
  return await withGatewayStack({
    ...
    resultConsumptionEnabled: input.resultConsumptionEnabled,
        ...
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditRequired:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditRequired === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditObserved:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditObserved === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditStatus:
          typeof decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditStatus === "string"
            ? decision.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditStatus
            : null,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReason:
          typeof decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReason === "string"
            ? decision.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReason
            : null,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditBlockedBy:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditBlockedBy ?? null,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAudit:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAudit ?? null,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditWouldAuditReceiptDecode:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditWouldAuditReceiptDecode === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditWouldRequireReceiptJws:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditWouldRequireReceiptJws === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditWouldRequireReceiptPayload:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditWouldRequireReceiptPayload === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditWouldRequireReceiptDecode:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditWouldRequireReceiptDecode === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditWouldRequireReceiptPayloadParse:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditWouldRequireReceiptPayloadParse === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditWouldRequireFinalizedSettlement:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditWouldRequireFinalizedSettlement === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditWouldRequireTupleBinding:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditWouldRequireTupleBinding === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditWouldRequireNoReplay:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditWouldRequireNoReplay === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReceiptJwsRequired:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReceiptJwsRequired === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReceiptPayloadRequired:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReceiptPayloadRequired === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReceiptDecodeRequired:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReceiptDecodeRequired === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReceiptJwsPresent:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReceiptJwsPresent === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReceiptPayloadPresent:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReceiptPayloadPresent === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReceiptMaterialObserved:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReceiptMaterialObserved === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReceiptMaterialHandled:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReceiptMaterialHandled === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReceiptMaterialConsumed:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReceiptMaterialConsumed === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReceiptDecoded:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReceiptDecoded === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReceiptPayloadParsed:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReceiptPayloadParsed === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditAllowsResultConsumption:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditAllowsResultConsumption === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditAllowsReceiptConsumption:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditAllowsReceiptConsumption === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditAllowsReceiptHandling:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditAllowsReceiptHandling === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditAllowsReceiptDecode:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditAllowsReceiptDecode === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditAllowsReceiptPayloadParse:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditAllowsReceiptPayloadParse === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditAllowsFinalizedSettlementVerification:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditAllowsFinalizedSettlementVerification === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditAllowsTupleBinding:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditAllowsTupleBinding === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditAllowsReplayCheck:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditAllowsReplayCheck === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditAllowsCrpFulfill:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditAllowsCrpFulfill === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditAllowsProductionRelease:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditAllowsProductionRelease === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditAdapterInvoked:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditAdapterInvoked === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditExternalCallAttempted:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditExternalCallAttempted === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditCrpCalled:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditCrpCalled === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditCrpFulfillCalled:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditCrpFulfillCalled === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditRawProofPrinted:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditRawProofPrinted === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditRawReceiptPrinted:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditRawReceiptPrinted === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditResultConsumed:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditResultConsumed === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReceiptConsumed:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReceiptConsumed === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditFinalizedSettlementVerified:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditFinalizedSettlementVerified === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditTupleBindingVerified:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditTupleBindingVerified === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReplayTouched:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReplayTouched === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditSideEffectFree:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditSideEffectFree === true,
...
async function main() {
  ...
  const summary = {
    ok: true,
    harness: "phase3.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAudit.v1",
    ...
    crpFulfillClientAdapterResultConsumptionReceiptMaterialHandlingGateSideEffectFree:
      ...
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptMaterialHandlingGateCrpFulfillCalled ===
        false,
    crpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditInactiveUntilReceiptDecodeHandlingGateObserved:
      switchOffDryRunOff.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditRequired ===
        false &&
      switchOffDryRunOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditRequired ===
        false &&
      switchOnDryRunOff.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditRequired ===
        false &&
      switchOnDryRunOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditRequired ===
        false,

    crpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditObservedAfterReceiptDecodeHandlingGate:
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditRequired ===
        true &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditObserved ===
        true &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditStatus ===
        "recorded" &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReason ===
        "production_release_crp_fulfill_client_adapter_result_consumption_receipt_decode_dry_run_audit_recorded" &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditBlockedBy ===
        "production_release_crp_fulfill_client_adapter_result_consumption_receipt_decode_handling_disabled",

    crpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditPreservesPreflightAndHandlingGateContext:
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAudit
        ?.source?.receiptDecodeHandlingGateStatus === "blocked" &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAudit
        ?.source?.receiptDecodeHandlingGateReason ===
        "production_release_crp_fulfill_client_adapter_result_consumption_receipt_decode_handling_disabled" &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAudit
        ?.source?.receiptDecodeHandlingGateBlockedBy ===
        "production_release_crp_fulfill_client_adapter_result_consumption_receipt_decode_handling_disabled" &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAudit
        ?.source?.receiptDecodeHandlingGateContract ===
        "phase3.productionRelease.crpFulfillClientAdapter.resultConsumptionReceiptDecodeHandlingGate.v1" &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAudit
        ?.source?.receiptDecodePreflightStatus === "preflight_ready" &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAudit
        ?.source?.receiptDecodePreflightReason ===
        "production_release_crp_fulfill_client_adapter_result_consumption_receipt_decode_preflight_ready" &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAudit
        ?.source?.receiptDecodePreflightBlockedBy === null &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAudit
        ?.source?.receiptDecodePreflightContract ===
      ...
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAudit
        ?.source?.receiptMaterialHandlingGateBlockedBy ===
        "production_release_crp_fulfill_client_adapter_result_consumption_receipt_material_handling_disabled",
    crpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditRecordsWouldAuditChecks:
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditWouldAuditReceiptDecode ===
        true &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditWouldRequireReceiptJws ===
        true &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditWouldRequireReceiptPayload ===
        true &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditWouldRequireReceiptDecode ===
        true &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditWouldRequireReceiptPayloadParse ===
        true &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditWouldRequireFinalizedSettlement ===
        true &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditWouldRequireTupleBinding ===
        true &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditWouldRequireNoReplay ===
        true &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAudit
        ?.audit?.wouldAuditReceiptDecode === true &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAudit
        ?.audit?.wouldRequireNoReplay === true &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReceiptJwsRequired ===
        true &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReceiptPayloadRequired ===
        true &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReceiptDecodeRequired ===
        true &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAudit
        ?.receiptDecode?.receiptJwsRequired === true &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAudit
        ?.receiptDecode?.receiptPayloadRequired === true &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAudit
        ?.receiptDecode?.receiptDecodeRequired === true,

    crpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditDoesNotObserveReceiptMaterial:
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReceiptJwsPresent ===
        false &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReceiptPayloadPresent ===
        false &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAudit
    ...
    crpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditDoesNotHandleOrConsumeReceiptMaterial:
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReceiptMaterialHandled ===
        false &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReceiptMaterialConsumed ===
        false &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReceiptConsumed ===
        false &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditAllowsReceiptHandling ===
        false,

    crpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditDoesNotDecodeOrParseReceipt:
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReceiptDecoded ===
        false &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReceiptPayloadParsed ===
        false &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditAllowsReceiptDecode ===
        false &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditAllowsReceiptPayloadParse ===
        false,

    crpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditDoesNotVerifySettlementOrTuple:
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditFinalizedSettlementVerified ===
        false &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditTupleBindingVerified ===
        false &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditAllowsFinalizedSettlementVerification ===
        false &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditAllowsTupleBinding ===
        false,

    crpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditDoesNotTouchReplay:
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditReplayTouched ===
        false &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditAllowsReplayCheck ===
        false,

    crpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditDoesNotAuthorizeProductionRelease:
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditAllowsProductionRelease ===
        false &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAudit
        ?.safety?.productionReleaseAuthorized === false &&
      switchOnDryRunOnResultConsumptionOn.productionRelease === false,

    crpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditSanitized:
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAudit
        ?.safety?.sanitized === true &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditRawProofPrinted ===
        false &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditRawReceiptPrinted ===
        false,

    crpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditSideEffectFree:
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditSideEffectFree ===
        true &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditAdapterInvoked ===
        false &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditExternalCallAttempted ===
        false &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditCrpCalled ===
        false &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditCrpFulfillCalled ===
        false,
  ...
  assert.equal(
    summary.crpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditInactiveUntilReceiptDecodeHandlingGateObserved,
    true,
  );
  assert.equal(
    summary.crpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditObservedAfterReceiptDecodeHandlingGate,
    true,
  );
  assert.equal(
    summary.crpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditPreservesPreflightAndHandlingGateContext,
    true,
  );
  assert.equal(
    summary.crpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditRecordsWouldAuditChecks,
    true,
  );
  assert.equal(
    summary.crpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditDoesNotObserveReceiptMaterial,
    true,
  );
  assert.equal(
    summary.crpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditDoesNotHandleOrConsumeReceiptMaterial,
    true,
  );
  assert.equal(
    summary.crpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditDoesNotDecodeOrParseReceipt,
    true,
  );
  assert.equal(
    summary.crpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditDoesNotVerifySettlementOrTuple,
    true,
  );
  assert.equal(
    summary.crpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditDoesNotTouchReplay,
    true,
  );
  assert.equal(
    summary.crpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditDoesNotAuthorizeProductionRelease,
    true,
  );
  assert.equal(
    summary.crpFulfillClientAdapterResultConsumptionReceiptDecodeDryRunAuditSideEffectFree,
    true,
  );
