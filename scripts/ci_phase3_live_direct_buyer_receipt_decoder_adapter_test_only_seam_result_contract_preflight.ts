#!/usr/bin/env node
/**
 * scripts/ci_phase3_live_direct_buyer_receipt_decoder_adapter_test_only_seam_result_contract_preflight.ts
 *
 * Milestone 3H / PR #239 harness.
 *
 ...
 * contract, a dry-run/stub adapter invocation preflight contract,
 * a test-only adapter-call contract preflight, a test-only invocation-seam
 * preflight, and a test-only seam-result contract bound to the fresh PAYMENT-REQUIRED tuple.
 *
 ...
 * does not invoke decode, proves the adapter invocation seam can return a sanitized non-decoded result contract under test-only control,
...
const GATEWAY_PORT = Number(process.env.PHASE3_LIVE_DIRECT_BUYER_RECEIPT_DECODER_ADAPTER_TEST_ONLY_SEAM_RESULT_CONTRACT_PREFLIGHT_PORT || 3105);
const JWKS_PORT = Number(process.env.PHASE3_LIVE_DIRECT_BUYER_RECEIPT_DECODER_ADAPTER_TEST_ONLY_SEAM_RESULT_CONTRACT_PREFLIGHT_JWKS_PORT || 8155);
const BASE = baseUrlForPort(GATEWAY_PORT);
const JWKS_BASE = baseUrlForPort(JWKS_PORT);
const LABEL = "phase3:live-direct-buyer-receipt-decoder-adapter-test-only-seam-result-contract-preflight-test";
...
const TEST_ONLY_ADAPTER_CALL_CONTRACT = process.env.PHASE3_LIVE_DIRECT_BUYER_RECEIPT_DECODER_ADAPTER_TEST_ONLY_CALL_CONTRACT === "true";
const TEST_ONLY_INVOCATION_SEAM = process.env.PHASE3_LIVE_DIRECT_BUYER_RECEIPT_DECODER_ADAPTER_TEST_ONLY_INVOCATION_SEAM === "true";
const TEST_ONLY_SEAM_RESULT_CONTRACT = process.env.PHASE3_LIVE_DIRECT_BUYER_RECEIPT_DECODER_ADAPTER_TEST_ONLY_SEAM_RESULT_CONTRACT === "true";
    ...
    JSON.stringify(
      {
        ...
        code: "usage",
        reason:
          "Usage: PHASE3_LIVE_DIRECT_BUYER_RECEIPT_DECODER_ADAPTER_TEST_ONLY_SEAM_RESULT_CONTRACT_PREFLIGHT_HARNESS=true npm run phase3:live-direct-buyer-receipt-decoder-adapter-test-only-seam-result-contract-preflight-test -- <local-wallet-proof.json>",
...
function buildSanitizedReceiptJwsHandoff(input: {
  ...
  return {
    ...
    decoderNoopResultContract: {
      ...
      realDecoderAdapterCallContractPreflight: {
        contract: "phase3.liveDirectBuyer.receiptDecoderAdapterTestOnlyCallContractPreflight.v1",
        mode: "test_only_adapter_call_contract",
        status: TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT ? "call_contract_ready" : "blocked",
        callContractDescriptorPresent: true,
        testOnlyGateOpenRequired: true,
        testOnlyGateOpenSatisfied: TEST_ONLY_GATE_OPEN,
        dryRunInvocationRequired: true,
        dryRunInvocationSatisfied: TEST_ONLY_DRY_RUN_INVOCATION,
        adapterCallContractFlagRequired: true,
        adapterCallContractFlagPresent: TEST_ONLY_ADAPTER_CALL_CONTRACT,
        adapterCallInputShapeBuilt: TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT,
        adapterCallInputMetadataOnly: true,
        adapterCallInputSanitized: true,
        adapterCallInputSource: "sanitized_handoff_metadata",
        adapterCallInputBoundToPaymentRequired: true,
        adapterCallInputNonceBound: true,
        adapterCallInputResourceBound: true,
        adapterCallInputContractBound: true,
        adapterCallInputMerchantBound: true,
        adapterCallInputPaymentTupleBound: true,
        adapterCallInputReceiptJwsIncluded: false,
        adapterCallInputReceiptPayloadIncluded: false,
        adapterCallInputReceiptBytesIncluded: false,
        adapterCallInputReceiptObjectIncluded: false,
        adapterCallInputRawReceiptIncluded: false,
        adapterCallInputRawProofIncluded: false,
        adapterCallInputSettlementFieldsIncluded: false,
        adapterCallInputReplayKeyIncluded: false,
        adapterCallInputRuntimeDecoderInputObjectIncluded: false,
        adapterCallInputActualDecoderInputObjectIncluded: false,
        adapterCallInvocationAllowed: TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT,
        adapterCallInvocationAttempted: TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT,
        adapterCallInvocationObserved: TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT,
        adapterStubInvoked: TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT,
        realDecoderAdapterInvoked: false,
        realDecoderInvoked: false,
        receiptMaterialAccepted: false,
        runtimeDecoderInputObjectBuilt: false,
        ...
        canonicalReleasePersistenceAllowed: false,
        productionReleaseAllowed: false,
        callContractFailures: TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT
          ? ["real_decoder_still_disabled", "receipt_material_not_accepted", "runtime_decoder_input_not_built", "release_consumption_disabled"]
          : ["test_only_gate_or_dry_run_or_call_contract_missing", "real_decoder_still_disabled", "receipt_material_not_accepted", "runtime_decoder_input_not_built"],
      },
      realDecoderAdapterInvocationSeamPreflight: {
        contract: "phase3.liveDirectBuyer.receiptDecoderAdapterTestOnlyInvocationSeamPreflight.v1",
        mode: "test_only_invocation_seam_preflight",
        status: TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT && TEST_ONLY_INVOCATION_SEAM ? "invocation_seam_observed" : "blocked",
        invocationSeamDescriptorPresent: true,
        testOnlyGateOpenRequired: true,
        testOnlyGateOpenSatisfied: TEST_ONLY_GATE_OPEN,
        dryRunInvocationRequired: true,
        dryRunInvocationSatisfied: TEST_ONLY_DRY_RUN_INVOCATION,
        adapterCallContractRequired: true,
        adapterCallContractSatisfied: TEST_ONLY_ADAPTER_CALL_CONTRACT,
        invocationSeamFlagRequired: true,
        invocationSeamFlagPresent: TEST_ONLY_INVOCATION_SEAM,
        adapterCallInputShapeRequired: true,
        adapterCallInputShapeSatisfied: TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT,
        invocationSeamEntryAllowed: TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT && TEST_ONLY_INVOCATION_SEAM,
        invocationSeamEntryAttempted: TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT && TEST_ONLY_INVOCATION_SEAM,
        invocationSeamEntryObserved: TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT && TEST_ONLY_INVOCATION_SEAM,
        invocationSeamRoute: "test_only_no_real_decode_stub",
        invocationSeamMetadataOnly: true,
        invocationSeamSanitized: true,
        invocationSeamBoundToPaymentRequired: true,
        invocationSeamNonceBound: true,
        invocationSeamResourceBound: true,
        invocationSeamContractBound: true,
        invocationSeamMerchantBound: true,
        invocationSeamPaymentTupleBound: true,
        adapterStubInvoked: TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT && TEST_ONLY_INVOCATION_SEAM,
        adapterSeamEntered: TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT && TEST_ONLY_INVOCATION_SEAM,
        adapterSeamExitedSafely: TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT && TEST_ONLY_INVOCATION_SEAM,
        realDecoderAdapterInvoked: false,
        realDecoderInvoked: false,
        receiptMaterialAccepted: false,
        receiptJwsAcceptedForDecode: false,
        ...
        canonicalReleasePersistenceAllowed: false,
        productionReleaseAllowed: false,
        invocationSeamFailures: TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT && TEST_ONLY_INVOCATION_SEAM
          ? ["real_decoder_still_disabled", "receipt_material_not_accepted", "runtime_decoder_input_not_built", "release_consumption_disabled"]
          : ["test_only_gate_or_dry_run_or_call_contract_or_invocation_seam_missing", "real_decoder_still_disabled", "receipt_material_not_accepted", "runtime_decoder_input_not_built"],
      },
      realDecoderAdapterSeamResultContractPreflight: {
        contract: "phase3.liveDirectBuyer.receiptDecoderAdapterTestOnlySeamResultContractPreflight.v1",
        mode: "test_only_seam_result_contract",
        status: TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT && TEST_ONLY_INVOCATION_SEAM && TEST_ONLY_SEAM_RESULT_CONTRACT ? "seam_result_contract_ready" : "blocked",
        seamResultDescriptorPresent: true,
        testOnlyGateOpenRequired: true,
        testOnlyGateOpenSatisfied: TEST_ONLY_GATE_OPEN,
        dryRunInvocationRequired: true,
        dryRunInvocationSatisfied: TEST_ONLY_DRY_RUN_INVOCATION,
        adapterCallContractRequired: true,
        adapterCallContractSatisfied: TEST_ONLY_ADAPTER_CALL_CONTRACT,
        invocationSeamRequired: true,
        invocationSeamSatisfied: TEST_ONLY_INVOCATION_SEAM,
        invocationSeamObservedRequired: true,
        invocationSeamObservedSatisfied: TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT && TEST_ONLY_INVOCATION_SEAM,
        seamResultContractFlagRequired: true,
        seamResultContractFlagPresent: TEST_ONLY_SEAM_RESULT_CONTRACT,
        seamResultBuilt: TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT && TEST_ONLY_INVOCATION_SEAM && TEST_ONLY_SEAM_RESULT_CONTRACT,
        seamResultObserved: TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT && TEST_ONLY_INVOCATION_SEAM && TEST_ONLY_SEAM_RESULT_CONTRACT,
        seamResultReturnedFromSeam: TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT && TEST_ONLY_INVOCATION_SEAM && TEST_ONLY_SEAM_RESULT_CONTRACT,
        seamResultRoute: "test_only_non_decoded_result_descriptor",
        ...
        seamResultKind: "non_decoded_adapter_seam_result",
        seamResultDecodeStatus: "not_decoded",
        seamResultReleaseConsumable: false,
        seamResultConsumedByReleaseDecision: false,
        seamResultMutatedReleaseDecision: false,
        ...
        canonicalReleasePersistenceAllowed: false,
        productionReleaseAllowed: false,
        seamResultFailures: TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT && TEST_ONLY_INVOCATION_SEAM && TEST_ONLY_SEAM_RESULT_CONTRACT
          ? ["real_decoder_still_disabled", "receipt_material_not_accepted", "runtime_decoder_input_not_built", "release_consumption_disabled"]
          : ["test_only_gate_or_dry_run_or_call_contract_or_invocation_seam_or_seam_result_missing", "real_decoder_still_disabled", "receipt_material_not_accepted", "runtime_decoder_input_not_built"],
      },
      binding: {
...
async function main() {
  ...
  if (String(process.env.PHASE3_LIVE_DIRECT_BUYER_RECEIPT_DECODER_ADAPTER_TEST_ONLY_SEAM_RESULT_CONTRACT_PREFLIGHT_HARNESS ?? "").toLowerCase() !== "true") {
    console.error(
      JSON.stringify(
        {
          ok: false,
          ...
          reason:
            "Set PHASE3_LIVE_DIRECT_BUYER_RECEIPT_DECODER_ADAPTER_TEST_ONLY_SEAM_RESULT_CONTRACT_PREFLIGHT_HARNESS=true to run this local-only harness.",
          rawProofPrinted: false,
          rawReceiptPrinted: false,
        },
        null,
  ...
  try {
    ...
    assert.equal(handoff.decoderNoopResultContract.resultReference.resultDerivedFromReceiptMaterial, false);
      ...
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.contract, "phase3.liveDirectBuyer.receiptDecoderAdapterTestOnlyCallContractPreflight.v1");
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.mode, "test_only_adapter_call_contract");
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.status, TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT ? "call_contract_ready" : "blocked");
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.callContractDescriptorPresent, true);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.testOnlyGateOpenRequired, true);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.testOnlyGateOpenSatisfied, TEST_ONLY_GATE_OPEN);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.dryRunInvocationRequired, true);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.dryRunInvocationSatisfied, TEST_ONLY_DRY_RUN_INVOCATION);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.adapterCallContractFlagRequired, true);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.adapterCallContractFlagPresent, TEST_ONLY_ADAPTER_CALL_CONTRACT);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.adapterCallInputShapeBuilt, TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.adapterCallInputMetadataOnly, true);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.adapterCallInputSanitized, true);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.adapterCallInputSource, "sanitized_handoff_metadata");
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.adapterCallInputBoundToPaymentRequired, true);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.adapterCallInputNonceBound, true);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.adapterCallInputResourceBound, true);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.adapterCallInputContractBound, true);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.adapterCallInputMerchantBound, true);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.adapterCallInputPaymentTupleBound, true);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.adapterCallInputReceiptJwsIncluded, false);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.adapterCallInputReceiptPayloadIncluded, false);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.adapterCallInputReceiptBytesIncluded, false);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.adapterCallInputReceiptObjectIncluded, false);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.adapterCallInputRawReceiptIncluded, false);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.adapterCallInputRawProofIncluded, false);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.adapterCallInputSettlementFieldsIncluded, false);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.adapterCallInputReplayKeyIncluded, false);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.adapterCallInputRuntimeDecoderInputObjectIncluded, false);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.adapterCallInputActualDecoderInputObjectIncluded, false);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.adapterCallInvocationAllowed, TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.adapterCallInvocationAttempted, TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.adapterCallInvocationObserved, TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.adapterStubInvoked, TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.realDecoderAdapterInvoked, false);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.realDecoderInvoked, false);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.receiptMaterialAccepted, false);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.runtimeDecoderInputObjectBuilt, false);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.actualDecoderInputObjectBuilt, false);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.decodedReceiptProduced, false);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.decodedReceiptVerified, false);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.decoderResultProduced, false);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.decoderResultConsumedByReleaseDecision, false);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.releaseDecisionMutatedByDecoderResult, false);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.paymentResponseEmissionAllowed, false);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.crpFulfillAllowed, false);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.replayMutationAllowed, false);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.canonicalReleasePersistenceAllowed, false);
      assert.equal(handoff.realDecoderAdapterCallContractPreflight.productionReleaseAllowed, false);
      assert.deepEqual(
        handoff.realDecoderAdapterCallContractPreflight.callContractFailures,
        TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT
          ? ["real_decoder_still_disabled", "receipt_material_not_accepted", "runtime_decoder_input_not_built", "release_consumption_disabled"]
          : ["test_only_gate_or_dry_run_or_call_contract_missing", "real_decoder_still_disabled", "receipt_material_not_accepted", "runtime_decoder_input_not_built"],
      );
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.contract, "phase3.liveDirectBuyer.receiptDecoderAdapterTestOnlyInvocationSeamPreflight.v1");
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.mode, "test_only_invocation_seam_preflight");
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.status, TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT && TEST_ONLY_INVOCATION_SEAM ? "invocation_seam_observed" : "blocked");
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.invocationSeamDescriptorPresent, true);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.testOnlyGateOpenRequired, true);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.testOnlyGateOpenSatisfied, TEST_ONLY_GATE_OPEN);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.dryRunInvocationRequired, true);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.dryRunInvocationSatisfied, TEST_ONLY_DRY_RUN_INVOCATION);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.adapterCallContractRequired, true);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.adapterCallContractSatisfied, TEST_ONLY_ADAPTER_CALL_CONTRACT);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.invocationSeamFlagRequired, true);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.invocationSeamFlagPresent, TEST_ONLY_INVOCATION_SEAM);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.adapterCallInputShapeRequired, true);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.adapterCallInputShapeSatisfied, TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.invocationSeamEntryAllowed, TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT && TEST_ONLY_INVOCATION_SEAM);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.invocationSeamEntryAttempted, TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT && TEST_ONLY_INVOCATION_SEAM);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.invocationSeamEntryObserved, TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT && TEST_ONLY_INVOCATION_SEAM);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.invocationSeamRoute, "test_only_no_real_decode_stub");
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.invocationSeamMetadataOnly, true);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.invocationSeamSanitized, true);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.invocationSeamBoundToPaymentRequired, true);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.invocationSeamNonceBound, true);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.invocationSeamResourceBound, true);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.invocationSeamContractBound, true);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.invocationSeamMerchantBound, true);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.invocationSeamPaymentTupleBound, true);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.adapterStubInvoked, TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT && TEST_ONLY_INVOCATION_SEAM);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.adapterSeamEntered, TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT && TEST_ONLY_INVOCATION_SEAM);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.adapterSeamExitedSafely, TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT && TEST_ONLY_INVOCATION_SEAM);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.realDecoderAdapterInvoked, false);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.realDecoderInvoked, false);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.receiptMaterialAccepted, false);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.receiptJwsAcceptedForDecode, false);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.receiptPayloadAcceptedForDecode, false);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.receiptBytesAcceptedForDecode, false);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.receiptObjectAcceptedForDecode, false);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.rawReceiptAcceptedForDecode, false);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.rawProofAcceptedForDecode, false);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.settlementFieldsAcceptedForDecode, false);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.replayKeyAcceptedForDecode, false);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.runtimeDecoderInputObjectBuilt, false);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.actualDecoderInputObjectBuilt, false);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.decodedReceiptProduced, false);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.decodedReceiptVerified, false);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.decoderResultProduced, false);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.decoderResultConsumedByReleaseDecision, false);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.releaseDecisionMutatedByDecoderResult, false);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.paymentResponseEmissionAllowed, false);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.crpFulfillAllowed, false);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.replayMutationAllowed, false);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.canonicalReleasePersistenceAllowed, false);
      assert.equal(handoff.realDecoderAdapterInvocationSeamPreflight.productionReleaseAllowed, false);
      assert.deepEqual(
        handoff.realDecoderAdapterInvocationSeamPreflight.invocationSeamFailures,
        TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT && TEST_ONLY_INVOCATION_SEAM
          ? ["real_decoder_still_disabled", "receipt_material_not_accepted", "runtime_decoder_input_not_built", "release_consumption_disabled"]
          : ["test_only_gate_or_dry_run_or_call_contract_or_invocation_seam_missing", "real_decoder_still_disabled", "receipt_material_not_accepted", "runtime_decoder_input_not_built"],
      );
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.contract, "phase3.liveDirectBuyer.receiptDecoderAdapterTestOnlySeamResultContractPreflight.v1");
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.mode, "test_only_seam_result_contract");
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.status, TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT && TEST_ONLY_INVOCATION_SEAM && TEST_ONLY_SEAM_RESULT_CONTRACT ? "seam_result_contract_ready" : "blocked");
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.seamResultDescriptorPresent, true);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.testOnlyGateOpenRequired, true);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.testOnlyGateOpenSatisfied, TEST_ONLY_GATE_OPEN);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.dryRunInvocationRequired, true);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.dryRunInvocationSatisfied, TEST_ONLY_DRY_RUN_INVOCATION);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.adapterCallContractRequired, true);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.adapterCallContractSatisfied, TEST_ONLY_ADAPTER_CALL_CONTRACT);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.invocationSeamRequired, true);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.invocationSeamSatisfied, TEST_ONLY_INVOCATION_SEAM);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.invocationSeamObservedRequired, true);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.invocationSeamObservedSatisfied, TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT && TEST_ONLY_INVOCATION_SEAM);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.seamResultContractFlagRequired, true);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.seamResultContractFlagPresent, TEST_ONLY_SEAM_RESULT_CONTRACT);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.seamResultBuilt, TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT && TEST_ONLY_INVOCATION_SEAM && TEST_ONLY_SEAM_RESULT_CONTRACT);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.seamResultObserved, TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT && TEST_ONLY_INVOCATION_SEAM && TEST_ONLY_SEAM_RESULT_CONTRACT);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.seamResultReturnedFromSeam, TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT && TEST_ONLY_INVOCATION_SEAM && TEST_ONLY_SEAM_RESULT_CONTRACT);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.seamResultRoute, "test_only_non_decoded_result_descriptor");
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.seamResultMetadataOnly, true);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.seamResultSanitized, true);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.seamResultBoundToPaymentRequired, true);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.seamResultNonceBound, true);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.seamResultResourceBound, true);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.seamResultContractBound, true);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.seamResultMerchantBound, true);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.seamResultPaymentTupleBound, true);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.seamResultKind, "non_decoded_adapter_seam_result");
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.seamResultDecodeStatus, "not_decoded");
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.seamResultReleaseConsumable, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.seamResultConsumedByReleaseDecision, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.seamResultMutatedReleaseDecision, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.seamResultContainsReceiptJws, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.seamResultContainsReceiptPayload, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.seamResultContainsReceiptBytes, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.seamResultContainsReceiptObject, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.seamResultContainsRawReceipt, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.seamResultContainsRawProof, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.seamResultContainsSettlementFields, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.seamResultContainsReplayKey, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.seamResultContainsRuntimeDecoderInputObject, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.seamResultContainsActualDecoderInputObject, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.realDecoderAdapterInvoked, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.realDecoderInvoked, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.receiptMaterialAccepted, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.receiptJwsAcceptedForDecode, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.receiptPayloadAcceptedForDecode, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.receiptBytesAcceptedForDecode, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.receiptObjectAcceptedForDecode, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.rawReceiptAcceptedForDecode, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.rawProofAcceptedForDecode, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.settlementFieldsAcceptedForDecode, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.replayKeyAcceptedForDecode, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.runtimeDecoderInputObjectBuilt, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.actualDecoderInputObjectBuilt, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.decodedReceiptProduced, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.decodedReceiptVerified, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.decoderResultProduced, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.decoderResultConsumedByReleaseDecision, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.releaseDecisionMutatedByDecoderResult, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.paymentResponseEmissionAllowed, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.crpFulfillAllowed, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.replayMutationAllowed, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.canonicalReleasePersistenceAllowed, false);
      assert.equal(handoff.realDecoderAdapterSeamResultContractPreflight.productionReleaseAllowed, false);
      assert.deepEqual(
        handoff.realDecoderAdapterSeamResultContractPreflight.seamResultFailures,
        TEST_ONLY_GATE_OPEN && TEST_ONLY_DRY_RUN_INVOCATION && TEST_ONLY_ADAPTER_CALL_CONTRACT && TEST_ONLY_INVOCATION_SEAM && TEST_ONLY_SEAM_RESULT_CONTRACT
          ? ["real_decoder_still_disabled", "receipt_material_not_accepted", "runtime_decoder_input_not_built", "release_consumption_disabled"]
          : ["test_only_gate_or_dry_run_or_call_contract_or_invocation_seam_or_seam_result_missing", "real_decoder_still_disabled", "receipt_material_not_accepted", "runtime_decoder_input_not_built"],
      );
    ...
    console.log(
      JSON.stringify(
        {
          ok: true,
          harness: "phase3.liveDirectBuyerReceiptDecoderAdapterTestOnlySeamResultContractPreflight.v1",
          ...
          decoderNoopResultDerivedFromReceiptMaterial: handoff.decoderNoopResultContract.resultReference.resultDerivedFromReceiptMaterial,
            ...
            realDecoderAdapterDryRunFailures: handoff.realDecoderAdapterDryRunInvocationPreflight.dryRunFailures,
              realDecoderAdapterCallContractContract: handoff.realDecoderAdapterCallContractPreflight.contract,
              realDecoderAdapterCallContractMode: handoff.realDecoderAdapterCallContractPreflight.mode,
              realDecoderAdapterCallContractStatus: handoff.realDecoderAdapterCallContractPreflight.status,
              realDecoderAdapterCallContractDescriptorPresent: handoff.realDecoderAdapterCallContractPreflight.callContractDescriptorPresent,
              realDecoderAdapterCallContractGateOpenRequired: handoff.realDecoderAdapterCallContractPreflight.testOnlyGateOpenRequired,
              realDecoderAdapterCallContractGateOpenSatisfied: handoff.realDecoderAdapterCallContractPreflight.testOnlyGateOpenSatisfied,
              realDecoderAdapterCallContractDryRunRequired: handoff.realDecoderAdapterCallContractPreflight.dryRunInvocationRequired,
              realDecoderAdapterCallContractDryRunSatisfied: handoff.realDecoderAdapterCallContractPreflight.dryRunInvocationSatisfied,
              realDecoderAdapterCallContractFlagRequired: handoff.realDecoderAdapterCallContractPreflight.adapterCallContractFlagRequired,
              realDecoderAdapterCallContractFlagPresent: handoff.realDecoderAdapterCallContractPreflight.adapterCallContractFlagPresent,
              realDecoderAdapterCallInputShapeBuilt: handoff.realDecoderAdapterCallContractPreflight.adapterCallInputShapeBuilt,
              realDecoderAdapterCallInputMetadataOnly: handoff.realDecoderAdapterCallContractPreflight.adapterCallInputMetadataOnly,
              realDecoderAdapterCallInputSanitized: handoff.realDecoderAdapterCallContractPreflight.adapterCallInputSanitized,
              realDecoderAdapterCallInputSource: handoff.realDecoderAdapterCallContractPreflight.adapterCallInputSource,
              realDecoderAdapterCallInputBoundToPaymentRequired: handoff.realDecoderAdapterCallContractPreflight.adapterCallInputBoundToPaymentRequired,
              realDecoderAdapterCallInputNonceBound: handoff.realDecoderAdapterCallContractPreflight.adapterCallInputNonceBound,
              realDecoderAdapterCallInputResourceBound: handoff.realDecoderAdapterCallContractPreflight.adapterCallInputResourceBound,
              realDecoderAdapterCallInputContractBound: handoff.realDecoderAdapterCallContractPreflight.adapterCallInputContractBound,
              realDecoderAdapterCallInputMerchantBound: handoff.realDecoderAdapterCallContractPreflight.adapterCallInputMerchantBound,
              realDecoderAdapterCallInputPaymentTupleBound: handoff.realDecoderAdapterCallContractPreflight.adapterCallInputPaymentTupleBound,
              realDecoderAdapterCallInputReceiptJwsIncluded: handoff.realDecoderAdapterCallContractPreflight.adapterCallInputReceiptJwsIncluded,
              realDecoderAdapterCallInputReceiptPayloadIncluded: handoff.realDecoderAdapterCallContractPreflight.adapterCallInputReceiptPayloadIncluded,
              realDecoderAdapterCallInputReceiptBytesIncluded: handoff.realDecoderAdapterCallContractPreflight.adapterCallInputReceiptBytesIncluded,
              realDecoderAdapterCallInputReceiptObjectIncluded: handoff.realDecoderAdapterCallContractPreflight.adapterCallInputReceiptObjectIncluded,
              realDecoderAdapterCallInputRawReceiptIncluded: handoff.realDecoderAdapterCallContractPreflight.adapterCallInputRawReceiptIncluded,
              realDecoderAdapterCallInputRawProofIncluded: handoff.realDecoderAdapterCallContractPreflight.adapterCallInputRawProofIncluded,
              realDecoderAdapterCallInputSettlementFieldsIncluded: handoff.realDecoderAdapterCallContractPreflight.adapterCallInputSettlementFieldsIncluded,
              realDecoderAdapterCallInputReplayKeyIncluded: handoff.realDecoderAdapterCallContractPreflight.adapterCallInputReplayKeyIncluded,
              realDecoderAdapterCallInputRuntimeDecoderInputObjectIncluded: handoff.realDecoderAdapterCallContractPreflight.adapterCallInputRuntimeDecoderInputObjectIncluded,
              realDecoderAdapterCallInputActualDecoderInputObjectIncluded: handoff.realDecoderAdapterCallContractPreflight.adapterCallInputActualDecoderInputObjectIncluded,
              realDecoderAdapterCallInvocationAllowed: handoff.realDecoderAdapterCallContractPreflight.adapterCallInvocationAllowed,
              realDecoderAdapterCallInvocationAttempted: handoff.realDecoderAdapterCallContractPreflight.adapterCallInvocationAttempted,
              realDecoderAdapterCallInvocationObserved: handoff.realDecoderAdapterCallContractPreflight.adapterCallInvocationObserved,
              realDecoderAdapterCallAdapterStubInvoked: handoff.realDecoderAdapterCallContractPreflight.adapterStubInvoked,
              realDecoderAdapterCallRealDecoderAdapterInvoked: handoff.realDecoderAdapterCallContractPreflight.realDecoderAdapterInvoked,
              realDecoderAdapterCallRealDecoderInvoked: handoff.realDecoderAdapterCallContractPreflight.realDecoderInvoked,
              realDecoderAdapterCallReceiptMaterialAccepted: handoff.realDecoderAdapterCallContractPreflight.receiptMaterialAccepted,
              realDecoderAdapterCallRuntimeDecoderInputObjectBuilt: handoff.realDecoderAdapterCallContractPreflight.runtimeDecoderInputObjectBuilt,
              realDecoderAdapterCallActualDecoderInputObjectBuilt: handoff.realDecoderAdapterCallContractPreflight.actualDecoderInputObjectBuilt,
              realDecoderAdapterCallDecodedReceiptProduced: handoff.realDecoderAdapterCallContractPreflight.decodedReceiptProduced,
              realDecoderAdapterCallDecodedReceiptVerified: handoff.realDecoderAdapterCallContractPreflight.decodedReceiptVerified,
              realDecoderAdapterCallDecoderResultProduced: handoff.realDecoderAdapterCallContractPreflight.decoderResultProduced,
              realDecoderAdapterCallDecoderResultConsumedByReleaseDecision: handoff.realDecoderAdapterCallContractPreflight.decoderResultConsumedByReleaseDecision,
              realDecoderAdapterCallReleaseDecisionMutatedByDecoderResult: handoff.realDecoderAdapterCallContractPreflight.releaseDecisionMutatedByDecoderResult,
              realDecoderAdapterCallPaymentResponseEmissionAllowed: handoff.realDecoderAdapterCallContractPreflight.paymentResponseEmissionAllowed,
              realDecoderAdapterCallCrpFulfillAllowed: handoff.realDecoderAdapterCallContractPreflight.crpFulfillAllowed,
              realDecoderAdapterCallReplayMutationAllowed: handoff.realDecoderAdapterCallContractPreflight.replayMutationAllowed,
              realDecoderAdapterCallCanonicalReleasePersistenceAllowed: handoff.realDecoderAdapterCallContractPreflight.canonicalReleasePersistenceAllowed,
              realDecoderAdapterCallProductionReleaseAllowed: handoff.realDecoderAdapterCallContractPreflight.productionReleaseAllowed,
              realDecoderAdapterCallFailures: handoff.realDecoderAdapterCallContractPreflight.callContractFailures,
              realDecoderAdapterInvocationSeamContract: handoff.realDecoderAdapterInvocationSeamPreflight.contract,
              realDecoderAdapterInvocationSeamMode: handoff.realDecoderAdapterInvocationSeamPreflight.mode,
              realDecoderAdapterInvocationSeamStatus: handoff.realDecoderAdapterInvocationSeamPreflight.status,
              realDecoderAdapterInvocationSeamDescriptorPresent: handoff.realDecoderAdapterInvocationSeamPreflight.invocationSeamDescriptorPresent,
              realDecoderAdapterInvocationSeamGateOpenRequired: handoff.realDecoderAdapterInvocationSeamPreflight.testOnlyGateOpenRequired,
              realDecoderAdapterInvocationSeamGateOpenSatisfied: handoff.realDecoderAdapterInvocationSeamPreflight.testOnlyGateOpenSatisfied,
              realDecoderAdapterInvocationSeamDryRunRequired: handoff.realDecoderAdapterInvocationSeamPreflight.dryRunInvocationRequired,
              realDecoderAdapterInvocationSeamDryRunSatisfied: handoff.realDecoderAdapterInvocationSeamPreflight.dryRunInvocationSatisfied,
              realDecoderAdapterInvocationSeamCallContractRequired: handoff.realDecoderAdapterInvocationSeamPreflight.adapterCallContractRequired,
              realDecoderAdapterInvocationSeamCallContractSatisfied: handoff.realDecoderAdapterInvocationSeamPreflight.adapterCallContractSatisfied,
              realDecoderAdapterInvocationSeamFlagRequired: handoff.realDecoderAdapterInvocationSeamPreflight.invocationSeamFlagRequired,
              realDecoderAdapterInvocationSeamFlagPresent: handoff.realDecoderAdapterInvocationSeamPreflight.invocationSeamFlagPresent,
              realDecoderAdapterInvocationSeamAdapterCallInputShapeRequired: handoff.realDecoderAdapterInvocationSeamPreflight.adapterCallInputShapeRequired,
              realDecoderAdapterInvocationSeamAdapterCallInputShapeSatisfied: handoff.realDecoderAdapterInvocationSeamPreflight.adapterCallInputShapeSatisfied,
              realDecoderAdapterInvocationSeamEntryAllowed: handoff.realDecoderAdapterInvocationSeamPreflight.invocationSeamEntryAllowed,
              realDecoderAdapterInvocationSeamEntryAttempted: handoff.realDecoderAdapterInvocationSeamPreflight.invocationSeamEntryAttempted,
              realDecoderAdapterInvocationSeamEntryObserved: handoff.realDecoderAdapterInvocationSeamPreflight.invocationSeamEntryObserved,
              realDecoderAdapterInvocationSeamRoute: handoff.realDecoderAdapterInvocationSeamPreflight.invocationSeamRoute,
              realDecoderAdapterInvocationSeamMetadataOnly: handoff.realDecoderAdapterInvocationSeamPreflight.invocationSeamMetadataOnly,
              realDecoderAdapterInvocationSeamSanitized: handoff.realDecoderAdapterInvocationSeamPreflight.invocationSeamSanitized,
              realDecoderAdapterInvocationSeamBoundToPaymentRequired: handoff.realDecoderAdapterInvocationSeamPreflight.invocationSeamBoundToPaymentRequired,
              realDecoderAdapterInvocationSeamNonceBound: handoff.realDecoderAdapterInvocationSeamPreflight.invocationSeamNonceBound,
              realDecoderAdapterInvocationSeamResourceBound: handoff.realDecoderAdapterInvocationSeamPreflight.invocationSeamResourceBound,
              realDecoderAdapterInvocationSeamContractBound: handoff.realDecoderAdapterInvocationSeamPreflight.invocationSeamContractBound,
              realDecoderAdapterInvocationSeamMerchantBound: handoff.realDecoderAdapterInvocationSeamPreflight.invocationSeamMerchantBound,
              realDecoderAdapterInvocationSeamPaymentTupleBound: handoff.realDecoderAdapterInvocationSeamPreflight.invocationSeamPaymentTupleBound,
              realDecoderAdapterInvocationSeamAdapterStubInvoked: handoff.realDecoderAdapterInvocationSeamPreflight.adapterStubInvoked,
              realDecoderAdapterInvocationSeamAdapterSeamEntered: handoff.realDecoderAdapterInvocationSeamPreflight.adapterSeamEntered,
              realDecoderAdapterInvocationSeamAdapterSeamExitedSafely: handoff.realDecoderAdapterInvocationSeamPreflight.adapterSeamExitedSafely,
              realDecoderAdapterInvocationSeamRealDecoderAdapterInvoked: handoff.realDecoderAdapterInvocationSeamPreflight.realDecoderAdapterInvoked,
              realDecoderAdapterInvocationSeamRealDecoderInvoked: handoff.realDecoderAdapterInvocationSeamPreflight.realDecoderInvoked,
              realDecoderAdapterInvocationSeamReceiptMaterialAccepted: handoff.realDecoderAdapterInvocationSeamPreflight.receiptMaterialAccepted,
              realDecoderAdapterInvocationSeamReceiptJwsAcceptedForDecode: handoff.realDecoderAdapterInvocationSeamPreflight.receiptJwsAcceptedForDecode,
              realDecoderAdapterInvocationSeamReceiptPayloadAcceptedForDecode: handoff.realDecoderAdapterInvocationSeamPreflight.receiptPayloadAcceptedForDecode,
              realDecoderAdapterInvocationSeamReceiptBytesAcceptedForDecode: handoff.realDecoderAdapterInvocationSeamPreflight.receiptBytesAcceptedForDecode,
              realDecoderAdapterInvocationSeamReceiptObjectAcceptedForDecode: handoff.realDecoderAdapterInvocationSeamPreflight.receiptObjectAcceptedForDecode,
              realDecoderAdapterInvocationSeamRawReceiptAcceptedForDecode: handoff.realDecoderAdapterInvocationSeamPreflight.rawReceiptAcceptedForDecode,
              realDecoderAdapterInvocationSeamRawProofAcceptedForDecode: handoff.realDecoderAdapterInvocationSeamPreflight.rawProofAcceptedForDecode,
              realDecoderAdapterInvocationSeamSettlementFieldsAcceptedForDecode: handoff.realDecoderAdapterInvocationSeamPreflight.settlementFieldsAcceptedForDecode,
              realDecoderAdapterInvocationSeamReplayKeyAcceptedForDecode: handoff.realDecoderAdapterInvocationSeamPreflight.replayKeyAcceptedForDecode,
              realDecoderAdapterInvocationSeamRuntimeDecoderInputObjectBuilt: handoff.realDecoderAdapterInvocationSeamPreflight.runtimeDecoderInputObjectBuilt,
              realDecoderAdapterInvocationSeamActualDecoderInputObjectBuilt: handoff.realDecoderAdapterInvocationSeamPreflight.actualDecoderInputObjectBuilt,
              realDecoderAdapterInvocationSeamDecodedReceiptProduced: handoff.realDecoderAdapterInvocationSeamPreflight.decodedReceiptProduced,
              realDecoderAdapterInvocationSeamDecodedReceiptVerified: handoff.realDecoderAdapterInvocationSeamPreflight.decodedReceiptVerified,
              realDecoderAdapterInvocationSeamDecoderResultProduced: handoff.realDecoderAdapterInvocationSeamPreflight.decoderResultProduced,
              realDecoderAdapterInvocationSeamDecoderResultConsumedByReleaseDecision: handoff.realDecoderAdapterInvocationSeamPreflight.decoderResultConsumedByReleaseDecision,
              realDecoderAdapterInvocationSeamReleaseDecisionMutatedByDecoderResult: handoff.realDecoderAdapterInvocationSeamPreflight.releaseDecisionMutatedByDecoderResult,
              realDecoderAdapterInvocationSeamPaymentResponseEmissionAllowed: handoff.realDecoderAdapterInvocationSeamPreflight.paymentResponseEmissionAllowed,
              realDecoderAdapterInvocationSeamCrpFulfillAllowed: handoff.realDecoderAdapterInvocationSeamPreflight.crpFulfillAllowed,
              realDecoderAdapterInvocationSeamReplayMutationAllowed: handoff.realDecoderAdapterInvocationSeamPreflight.replayMutationAllowed,
              realDecoderAdapterInvocationSeamCanonicalReleasePersistenceAllowed: handoff.realDecoderAdapterInvocationSeamPreflight.canonicalReleasePersistenceAllowed,
              realDecoderAdapterInvocationSeamProductionReleaseAllowed: handoff.realDecoderAdapterInvocationSeamPreflight.productionReleaseAllowed,
              realDecoderAdapterInvocationSeamFailures: handoff.realDecoderAdapterInvocationSeamPreflight.invocationSeamFailures,
              realDecoderAdapterSeamResultContract: handoff.realDecoderAdapterSeamResultContractPreflight.contract,
              realDecoderAdapterSeamResultMode: handoff.realDecoderAdapterSeamResultContractPreflight.mode,
              realDecoderAdapterSeamResultStatus: handoff.realDecoderAdapterSeamResultContractPreflight.status,
              realDecoderAdapterSeamResultDescriptorPresent: handoff.realDecoderAdapterSeamResultContractPreflight.seamResultDescriptorPresent,
              realDecoderAdapterSeamResultGateOpenRequired: handoff.realDecoderAdapterSeamResultContractPreflight.testOnlyGateOpenRequired,
              realDecoderAdapterSeamResultGateOpenSatisfied: handoff.realDecoderAdapterSeamResultContractPreflight.testOnlyGateOpenSatisfied,
              realDecoderAdapterSeamResultDryRunRequired: handoff.realDecoderAdapterSeamResultContractPreflight.dryRunInvocationRequired,
              realDecoderAdapterSeamResultDryRunSatisfied: handoff.realDecoderAdapterSeamResultContractPreflight.dryRunInvocationSatisfied,
              realDecoderAdapterSeamResultCallContractRequired: handoff.realDecoderAdapterSeamResultContractPreflight.adapterCallContractRequired,
              realDecoderAdapterSeamResultCallContractSatisfied: handoff.realDecoderAdapterSeamResultContractPreflight.adapterCallContractSatisfied,
              realDecoderAdapterSeamResultInvocationSeamRequired: handoff.realDecoderAdapterSeamResultContractPreflight.invocationSeamRequired,
              realDecoderAdapterSeamResultInvocationSeamSatisfied: handoff.realDecoderAdapterSeamResultContractPreflight.invocationSeamSatisfied,
              realDecoderAdapterSeamResultInvocationSeamObservedRequired: handoff.realDecoderAdapterSeamResultContractPreflight.invocationSeamObservedRequired,
              realDecoderAdapterSeamResultInvocationSeamObservedSatisfied: handoff.realDecoderAdapterSeamResultContractPreflight.invocationSeamObservedSatisfied,
              realDecoderAdapterSeamResultFlagRequired: handoff.realDecoderAdapterSeamResultContractPreflight.seamResultContractFlagRequired,
              realDecoderAdapterSeamResultFlagPresent: handoff.realDecoderAdapterSeamResultContractPreflight.seamResultContractFlagPresent,
              realDecoderAdapterSeamResultBuilt: handoff.realDecoderAdapterSeamResultContractPreflight.seamResultBuilt,
              realDecoderAdapterSeamResultObserved: handoff.realDecoderAdapterSeamResultContractPreflight.seamResultObserved,
              realDecoderAdapterSeamResultReturnedFromSeam: handoff.realDecoderAdapterSeamResultContractPreflight.seamResultReturnedFromSeam,
              realDecoderAdapterSeamResultRoute: handoff.realDecoderAdapterSeamResultContractPreflight.seamResultRoute,
              realDecoderAdapterSeamResultMetadataOnly: handoff.realDecoderAdapterSeamResultContractPreflight.seamResultMetadataOnly,
              realDecoderAdapterSeamResultSanitized: handoff.realDecoderAdapterSeamResultContractPreflight.seamResultSanitized,
              realDecoderAdapterSeamResultBoundToPaymentRequired: handoff.realDecoderAdapterSeamResultContractPreflight.seamResultBoundToPaymentRequired,
              realDecoderAdapterSeamResultNonceBound: handoff.realDecoderAdapterSeamResultContractPreflight.seamResultNonceBound,
              realDecoderAdapterSeamResultResourceBound: handoff.realDecoderAdapterSeamResultContractPreflight.seamResultResourceBound,
              realDecoderAdapterSeamResultContractBound: handoff.realDecoderAdapterSeamResultContractPreflight.seamResultContractBound,
              realDecoderAdapterSeamResultMerchantBound: handoff.realDecoderAdapterSeamResultContractPreflight.seamResultMerchantBound,
              realDecoderAdapterSeamResultPaymentTupleBound: handoff.realDecoderAdapterSeamResultContractPreflight.seamResultPaymentTupleBound,
              realDecoderAdapterSeamResultKind: handoff.realDecoderAdapterSeamResultContractPreflight.seamResultKind,
              realDecoderAdapterSeamResultDecodeStatus: handoff.realDecoderAdapterSeamResultContractPreflight.seamResultDecodeStatus,
              realDecoderAdapterSeamResultReleaseConsumable: handoff.realDecoderAdapterSeamResultContractPreflight.seamResultReleaseConsumable,
              realDecoderAdapterSeamResultConsumedByReleaseDecision: handoff.realDecoderAdapterSeamResultContractPreflight.seamResultConsumedByReleaseDecision,
              realDecoderAdapterSeamResultMutatedReleaseDecision: handoff.realDecoderAdapterSeamResultContractPreflight.seamResultMutatedReleaseDecision,
              realDecoderAdapterSeamResultContainsReceiptJws: handoff.realDecoderAdapterSeamResultContractPreflight.seamResultContainsReceiptJws,
              realDecoderAdapterSeamResultContainsReceiptPayload: handoff.realDecoderAdapterSeamResultContractPreflight.seamResultContainsReceiptPayload,
              realDecoderAdapterSeamResultContainsReceiptBytes: handoff.realDecoderAdapterSeamResultContractPreflight.seamResultContainsReceiptBytes,
              realDecoderAdapterSeamResultContainsReceiptObject: handoff.realDecoderAdapterSeamResultContractPreflight.seamResultContainsReceiptObject,
              realDecoderAdapterSeamResultContainsRawReceipt: handoff.realDecoderAdapterSeamResultContractPreflight.seamResultContainsRawReceipt,
              realDecoderAdapterSeamResultContainsRawProof: handoff.realDecoderAdapterSeamResultContractPreflight.seamResultContainsRawProof,
              realDecoderAdapterSeamResultContainsSettlementFields: handoff.realDecoderAdapterSeamResultContractPreflight.seamResultContainsSettlementFields,
              realDecoderAdapterSeamResultContainsReplayKey: handoff.realDecoderAdapterSeamResultContractPreflight.seamResultContainsReplayKey,
              realDecoderAdapterSeamResultContainsRuntimeDecoderInputObject: handoff.realDecoderAdapterSeamResultContractPreflight.seamResultContainsRuntimeDecoderInputObject,
              realDecoderAdapterSeamResultContainsActualDecoderInputObject: handoff.realDecoderAdapterSeamResultContractPreflight.seamResultContainsActualDecoderInputObject,
              realDecoderAdapterSeamResultRealDecoderAdapterInvoked: handoff.realDecoderAdapterSeamResultContractPreflight.realDecoderAdapterInvoked,
              realDecoderAdapterSeamResultRealDecoderInvoked: handoff.realDecoderAdapterSeamResultContractPreflight.realDecoderInvoked,
              realDecoderAdapterSeamResultReceiptMaterialAccepted: handoff.realDecoderAdapterSeamResultContractPreflight.receiptMaterialAccepted,
              realDecoderAdapterSeamResultRuntimeDecoderInputObjectBuilt: handoff.realDecoderAdapterSeamResultContractPreflight.runtimeDecoderInputObjectBuilt,
              realDecoderAdapterSeamResultActualDecoderInputObjectBuilt: handoff.realDecoderAdapterSeamResultContractPreflight.actualDecoderInputObjectBuilt,
              realDecoderAdapterSeamResultDecodedReceiptProduced: handoff.realDecoderAdapterSeamResultContractPreflight.decodedReceiptProduced,
              realDecoderAdapterSeamResultDecodedReceiptVerified: handoff.realDecoderAdapterSeamResultContractPreflight.decodedReceiptVerified,
              realDecoderAdapterSeamResultDecoderResultProduced: handoff.realDecoderAdapterSeamResultContractPreflight.decoderResultProduced,
              realDecoderAdapterSeamResultDecoderResultConsumedByReleaseDecision: handoff.realDecoderAdapterSeamResultContractPreflight.decoderResultConsumedByReleaseDecision,
              realDecoderAdapterSeamResultReleaseDecisionMutatedByDecoderResult: handoff.realDecoderAdapterSeamResultContractPreflight.releaseDecisionMutatedByDecoderResult,
              realDecoderAdapterSeamResultPaymentResponseEmissionAllowed: handoff.realDecoderAdapterSeamResultContractPreflight.paymentResponseEmissionAllowed,
              realDecoderAdapterSeamResultCrpFulfillAllowed: handoff.realDecoderAdapterSeamResultContractPreflight.crpFulfillAllowed,
              realDecoderAdapterSeamResultReplayMutationAllowed: handoff.realDecoderAdapterSeamResultContractPreflight.replayMutationAllowed,
              realDecoderAdapterSeamResultCanonicalReleasePersistenceAllowed: handoff.realDecoderAdapterSeamResultContractPreflight.canonicalReleasePersistenceAllowed,
              realDecoderAdapterSeamResultProductionReleaseAllowed: handoff.realDecoderAdapterSeamResultContractPreflight.productionReleaseAllowed,
              realDecoderAdapterSeamResultFailures: handoff.realDecoderAdapterSeamResultContractPreflight.seamResultFailures,
