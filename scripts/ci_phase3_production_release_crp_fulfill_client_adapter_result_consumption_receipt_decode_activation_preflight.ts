...
const LABEL = "phase3:production-release-crp-fulfill-client-adapter-result-consumption-receipt-decode-activation-preflight-test";

const SWITCH_OFF_GATEWAY_PORT = Number(process.env.PHASE3_PROD_CRP_FULFILL_CLIENT_ADAPTER_RESULT_CONSUMPTION_RECEIPT_DECODE_ACTIVATION_PREFLIGHT_OFF_PORT || 3144);
const SWITCH_OFF_JWKS_PORT = Number(process.env.PHASE3_PROD_CRP_FULFILL_CLIENT_ADAPTER_RESULT_CONSUMPTION_RECEIPT_DECODE_ACTIVATION_PREFLIGHT_OFF_JWKS_PORT || 8154);

const SWITCH_ON_GATEWAY_PORT = Number(process.env.PHASE3_PROD_CRP_FULFILL_CLIENT_ADAPTER_RESULT_CONSUMPTION_RECEIPT_DECODE_ACTIVATION_PREFLIGHT_ON_PORT || 3145);
const SWITCH_ON_JWKS_PORT = Number(process.env.PHASE3_PROD_CRP_FULFILL_CLIENT_ADAPTER_RESULT_CONSUMPTION_RECEIPT_DECODE_ACTIVATION_PREFLIGHT_ON_JWKS_PORT || 8155);
...
async function main() {
  ...
  const summary = {
    ok: true,
    harness: "phase3.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeActivationPreflight.v1",
    ...
    JSON.stringify(
      {
        ...
        activationPreflightInactiveUntilEnablementGateEnabled:
          summary.crpFulfillClientAdapterResultConsumptionReceiptDecodeActivationPreflightInactiveUntilEnablementGateEnabled,
        activationPreflightObservedAfterEnablementGateEnabled:
          summary.crpFulfillClientAdapterResultConsumptionReceiptDecodeActivationPreflightObservedAfterEnablementGateEnabled,
        activationPreflightPreservesEnablementContextAndRecordsRequirements:
          summary.crpFulfillClientAdapterResultConsumptionReceiptDecodeActivationPreflightPreservesEnablementContextAndRecordsRequirements,
        activationPreflightStillBlocksAllExecution:
          summary.crpFulfillClientAdapterResultConsumptionReceiptDecodeActivationPreflightStillBlocksAllExecution,
