#!/usr/bin/env node
/**
 * PR #200 — Phase 3 production release CRP fulfill client adapter result handling gate boundary.
 *
 * This harness proves the Gateway observes the result decision gate,
 * then blocks downstream result handling/consumption through an explicit handling gate.
 *
...
const LABEL = "phase3:production-release-crp-fulfill-client-adapter-result-handling-gate-test";

const SWITCH_OFF_GATEWAY_PORT = Number(process.env.PHASE3_PROD_CRP_FULFILL_CLIENT_ADAPTER_RESULT_HANDLING_GATE_OFF_PORT || 3112);
const SWITCH_OFF_JWKS_PORT = Number(process.env.PHASE3_PROD_CRP_FULFILL_CLIENT_ADAPTER_RESULT_HANDLING_GATE_OFF_JWKS_PORT || 8122);

const SWITCH_ON_GATEWAY_PORT = Number(process.env.PHASE3_PROD_CRP_FULFILL_CLIENT_ADAPTER_RESULT_HANDLING_GATE_ON_PORT || 3113);
const SWITCH_ON_JWKS_PORT = Number(process.env.PHASE3_PROD_CRP_FULFILL_CLIENT_ADAPTER_RESULT_HANDLING_GATE_ON_JWKS_PORT || 8123);
      ...
      return {
        ...
        productionReleaseCrpFulfillRequestDraft:
          ...
          productionReleaseCrpFulfillClientAdapterResultHandlingGateAllowsCrpFulfill:
            decision?.productionReleaseCrpFulfillClientAdapterResultHandlingGateAllowsCrpFulfill === true,
          productionReleaseCrpFulfillClientAdapterResultHandlingGateAllowsProductionRelease:
            decision?.productionReleaseCrpFulfillClientAdapterResultHandlingGateAllowsProductionRelease === true,
          productionReleaseCrpFulfillClientAdapterResultHandlingGateAdapterInvoked:
            decision?.productionReleaseCrpFulfillClientAdapterResultHandlingGateAdapterInvoked === true,
          productionReleaseCrpFulfillClientAdapterResultHandlingGateExternalCallAttempted:
            decision?.productionReleaseCrpFulfillClientAdapterResultHandlingGateExternalCallAttempted === true,
          productionReleaseCrpFulfillClientAdapterResultHandlingGateCrpCalled:
            decision?.productionReleaseCrpFulfillClientAdapterResultHandlingGateCrpCalled === true,
          productionReleaseCrpFulfillClientAdapterResultHandlingGateCrpFulfillCalled:
            decision?.productionReleaseCrpFulfillClientAdapterResultHandlingGateCrpFulfillCalled === true,
...
async function main() {
  ...
  const summary = {
    ok: true,
    harness: "phase3.productionReleaseCrpFulfillClientAdapterResultHandlingGate.v1",
    ...
    crpFulfillRequestDraftSideEffectFree:
      ...
      crpFulfillClientAdapterResultHandlingGateInactiveUntilDecisionGateObserved:
        switchOffDryRunOff.productionReleaseCrpFulfillClientAdapterResultHandlingGateRequired ===
          false &&
        switchOffDryRunOff.productionReleaseCrpFulfillClientAdapterResultHandlingGateObserved ===
          false &&
        switchOffDryRunOff.productionReleaseCrpFulfillClientAdapterResultHandlingGateStatus ===
          "inactive" &&
        switchOffDryRunOff.productionReleaseCrpFulfillClientAdapterResultHandlingGate === null &&
        switchOffDryRunOn.productionReleaseCrpFulfillClientAdapterResultHandlingGateRequired ===
          false &&
        switchOffDryRunOn.productionReleaseCrpFulfillClientAdapterResultHandlingGateObserved ===
          false &&
        switchOffDryRunOn.productionReleaseCrpFulfillClientAdapterResultHandlingGateStatus ===
          "inactive" &&
        switchOffDryRunOn.productionReleaseCrpFulfillClientAdapterResultHandlingGate === null &&
        switchOnDryRunOff.productionReleaseCrpFulfillClientAdapterResultHandlingGateRequired ===
          false &&
        switchOnDryRunOff.productionReleaseCrpFulfillClientAdapterResultHandlingGateObserved ===
          false &&
        switchOnDryRunOff.productionReleaseCrpFulfillClientAdapterResultHandlingGateStatus ===
          "inactive" &&
        switchOnDryRunOff.productionReleaseCrpFulfillClientAdapterResultHandlingGate === null,
      crpFulfillClientAdapterResultHandlingGateObservedAfterDecisionGate:
        switchOnDryRunOn.productionReleaseCrpFulfillClientAdapterResultDecisionGateObserved ===
          true &&
        switchOnDryRunOn.productionReleaseCrpFulfillClientAdapterResultHandlingGateRequired ===
          true &&
        switchOnDryRunOn.productionReleaseCrpFulfillClientAdapterResultHandlingGateObserved ===
          true &&
        switchOnDryRunOn.productionReleaseCrpFulfillClientAdapterResultHandlingGateStatus ===
          "blocked" &&
        switchOnDryRunOn.productionReleaseCrpFulfillClientAdapterResultHandlingGateReason ===
          "production_release_crp_fulfill_client_adapter_result_handling_disabled" &&
        switchOnDryRunOn.productionReleaseCrpFulfillClientAdapterResultHandlingGateBlockedBy ===
          "production_release_crp_fulfill_client_adapter_result_handling_disabled",
      crpFulfillClientAdapterResultHandlingGateBlocksResultConsumption:
        switchOnDryRunOn.productionReleaseCrpFulfillClientAdapterResultHandlingGateAllowsResultConsumption ===
          false &&
        switchOnDryRunOn.productionReleaseCrpFulfillClientAdapterResultHandlingGateAllowsCrpFulfill ===
          false &&
        switchOnDryRunOn.productionReleaseCrpFulfillClientAdapterResultHandlingGateAllowsProductionRelease ===
          false &&
        switchOnDryRunOn.productionReleaseCrpFulfillClientAdapterResultHandlingGate
        ...
        switchOnDryRunOn.productionReleaseCrpFulfillClientAdapterResultHandlingGate
          ?.productionRelease === false,
      crpFulfillClientAdapterResultHandlingGatePreservesDecisionContext:
        switchOnDryRunOn.productionReleaseCrpFulfillClientAdapterResultHandlingGate?.decisionGateStatus ===
          "blocked" &&
        switchOnDryRunOn.productionReleaseCrpFulfillClientAdapterResultHandlingGate?.decisionGateReason ===
          "production_release_crp_fulfill_client_adapter_result_disabled" &&
        switchOnDryRunOn.productionReleaseCrpFulfillClientAdapterResultHandlingGate?.decisionGateBlockedBy ===
          "production_release_crp_fulfill_client_adapter_result_disabled" &&
        switchOnDryRunOn.productionReleaseCrpFulfillClientAdapterResultHandlingGate?.resultStatus ===
          "disabled" &&
        switchOnDryRunOn.productionReleaseCrpFulfillClientAdapterResultHandlingGate?.resultReason ===
          "production_release_crp_fulfill_client_adapter_result_contract_noop_disabled" &&
        switchOnDryRunOn.productionReleaseCrpFulfillClientAdapterResultHandlingGate?.resultMode ===
          "contract_only",
      crpFulfillClientAdapterResultHandlingGateSideEffectFree:
        switchOnDryRunOn.productionReleaseCrpFulfillClientAdapterResultHandlingGateAdapterInvoked ===
          false &&
        switchOnDryRunOn.productionReleaseCrpFulfillClientAdapterResultHandlingGateExternalCallAttempted ===
          false &&
        switchOnDryRunOn.productionReleaseCrpFulfillClientAdapterResultHandlingGateCrpCalled ===
          false &&
        switchOnDryRunOn.productionReleaseCrpFulfillClientAdapterResultHandlingGateCrpFulfillCalled ===
          false &&
        switchOnDryRunOn.productionReleaseCrpFulfillClientAdapterResultHandlingGateSideEffectFree ===
          true &&
        switchOnDryRunOn.productionReleaseCrpFulfillClientAdapterResultHandlingGate?.adapterInvoked ===
          false &&
        switchOnDryRunOn.productionReleaseCrpFulfillClientAdapterResultHandlingGate
          ?.externalCallAttempted === false &&
        switchOnDryRunOn.productionReleaseCrpFulfillClientAdapterResultHandlingGate?.crpCalled ===
          false &&
        switchOnDryRunOn.productionReleaseCrpFulfillClientAdapterResultHandlingGate
          ?.crpFulfillCalled === false,
  ...
  assert.equal(summary.crpFulfillClientAdapterResultHandlingGateInactiveUntilDecisionGateObserved, true);
  assert.equal(summary.crpFulfillClientAdapterResultHandlingGateObservedAfterDecisionGate, true);
  assert.equal(summary.crpFulfillClientAdapterResultHandlingGateBlocksResultConsumption, true);
  assert.equal(summary.crpFulfillClientAdapterResultHandlingGatePreservesDecisionContext, true);
  assert.equal(summary.crpFulfillClientAdapterResultHandlingGateSideEffectFree, true);
