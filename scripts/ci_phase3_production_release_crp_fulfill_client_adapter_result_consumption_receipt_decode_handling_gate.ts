#!/usr/bin/env node
/**
 * PR #214 — Phase 3 production release CRP fulfill client adapter result consumption receipt decode handling gate.
 *
 * This harness proves the Gateway observes the receipt material handling gate, then exposes
 * a receipt decode handling gate that blocks decoding, parsing, or verifying receipt material.
 *
 ...
 * - switch ON  + dry-run ON  + result consumption ON  => receipt decode handling gate observed as blocked and non-decoding
...
const LABEL = "phase3:production-release-crp-fulfill-client-adapter-result-consumption-receipt-decode-handling-gate-test";

const SWITCH_OFF_GATEWAY_PORT = Number(process.env.PHASE3_PROD_CRP_FULFILL_CLIENT_ADAPTER_RESULT_CONSUMPTION_RECEIPT_DECODE_HANDLING_GATE_OFF_PORT || 3138);
const SWITCH_OFF_JWKS_PORT = Number(process.env.PHASE3_PROD_CRP_FULFILL_CLIENT_ADAPTER_RESULT_CONSUMPTION_RECEIPT_DECODE_HANDLING_GATE_OFF_JWKS_PORT || 8148);

const SWITCH_ON_GATEWAY_PORT = Number(process.env.PHASE3_PROD_CRP_FULFILL_CLIENT_ADAPTER_RESULT_CONSUMPTION_RECEIPT_DECODE_HANDLING_GATE_ON_PORT || 3139);
const SWITCH_ON_JWKS_PORT = Number(process.env.PHASE3_PROD_CRP_FULFILL_CLIENT_ADAPTER_RESULT_CONSUMPTION_RECEIPT_DECODE_HANDLING_GATE_ON_JWKS_PORT || 8149);
  ...
  return await withGatewayStack({
    ...
    resultConsumptionEnabled: input.resultConsumptionEnabled,
        ...
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateRequired:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateRequired === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateObserved:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateObserved === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateStatus:
          typeof decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateStatus === "string"
            ? decision.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateStatus
            : null,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReason:
          typeof decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReason === "string"
            ? decision.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReason
            : null,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateBlockedBy:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateBlockedBy ?? null,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGate:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGate ?? null,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReceiptJwsRequired:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReceiptJwsRequired === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReceiptPayloadRequired:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReceiptPayloadRequired === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReceiptDecodeRequired:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReceiptDecodeRequired === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReceiptJwsPresent:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReceiptJwsPresent === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReceiptPayloadPresent:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReceiptPayloadPresent === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReceiptMaterialHandled:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReceiptMaterialHandled === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReceiptMaterialConsumed:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReceiptMaterialConsumed === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReceiptDecoded:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReceiptDecoded === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReceiptPayloadParsed:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReceiptPayloadParsed === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateAllowsResultConsumption:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateAllowsResultConsumption === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateAllowsReceiptConsumption:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateAllowsReceiptConsumption === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateAllowsReceiptHandling:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateAllowsReceiptHandling === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateAllowsReceiptDecode:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateAllowsReceiptDecode === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateAllowsReceiptPayloadParse:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateAllowsReceiptPayloadParse === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateAllowsFinalizedSettlementVerification:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateAllowsFinalizedSettlementVerification === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateAllowsTupleBinding:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateAllowsTupleBinding === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateAllowsReplayCheck:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateAllowsReplayCheck === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateAllowsCrpFulfill:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateAllowsCrpFulfill === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateAllowsProductionRelease:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateAllowsProductionRelease === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateAdapterInvoked:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateAdapterInvoked === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateExternalCallAttempted:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateExternalCallAttempted === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateCrpCalled:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateCrpCalled === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateCrpFulfillCalled:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateCrpFulfillCalled === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateResultConsumed:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateResultConsumed === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReceiptConsumed:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReceiptConsumed === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateFinalizedSettlementVerified:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateFinalizedSettlementVerified === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateTupleBindingVerified:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateTupleBindingVerified === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReplayTouched:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReplayTouched === true,
        productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateSideEffectFree:
          decision?.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateSideEffectFree === true,
...
async function main() {
  ...
  const summary = {
    ok: true,
    harness: "phase3.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGate.v1",
    ...
    crpFulfillClientAdapterResultConsumptionReceiptMaterialHandlingGateSideEffectFree:
      ...
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptMaterialHandlingGateCrpFulfillCalled ===
        false,
    crpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateInactiveUntilReceiptDecodePreflightReady:
      switchOffDryRunOff.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateRequired ===
        false &&
      switchOffDryRunOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateRequired ===
        false &&
      switchOnDryRunOff.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateRequired ===
        false &&
      switchOnDryRunOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateRequired ===
        false,

    crpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateObservedAfterReceiptDecodePreflight:
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateRequired ===
        true &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateObserved ===
        true &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateStatus ===
        "blocked" &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReason ===
        "production_release_crp_fulfill_client_adapter_result_consumption_receipt_decode_handling_disabled" &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateBlockedBy ===
        "production_release_crp_fulfill_client_adapter_result_consumption_receipt_decode_handling_disabled",

    crpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGatePreservesPreflightAndHandlingGateContext:
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGate
      ...
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGate
        ...
        "production_release_crp_fulfill_client_adapter_result_consumption_receipt_material_handling_disabled",
    crpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateRecordsDecodeRequirements:
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReceiptJwsRequired ===
        true &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReceiptPayloadRequired ===
        true &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReceiptDecodeRequired ===
        true &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGate
    ...
    crpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateDoesNotObserveReceiptMaterial:
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReceiptJwsPresent ===
        false &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReceiptPayloadPresent ===
        false &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGate
    ...
    crpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateDoesNotHandleOrConsumeReceiptMaterial:
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReceiptMaterialHandled ===
        false &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReceiptMaterialConsumed ===
        false &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReceiptConsumed ===
        false &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateAllowsReceiptHandling ===
        false,

    crpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateDoesNotDecodeOrParseReceipt:
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReceiptDecoded ===
        false &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReceiptPayloadParsed ===
        false &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateAllowsReceiptDecode ===
        false &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateAllowsReceiptPayloadParse ===
        false,

    crpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateDoesNotVerifySettlementOrTuple:
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateFinalizedSettlementVerified ===
        false &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateTupleBindingVerified ===
        false &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateAllowsFinalizedSettlementVerification ===
        false &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateAllowsTupleBinding ===
        false,

    crpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateDoesNotTouchReplay:
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateReplayTouched ===
        false &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateAllowsReplayCheck ===
        false,

    crpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateDoesNotAuthorizeProductionRelease:
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateAllowsProductionRelease ===
        false &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGate
        ?.safety?.productionReleaseAuthorized === false &&
      switchOnDryRunOnResultConsumptionOn.productionRelease === false,

    crpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateSideEffectFree:
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateSideEffectFree ===
        true &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateAdapterInvoked ===
        false &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateExternalCallAttempted ===
        false &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateCrpCalled ===
        false &&
      switchOnDryRunOnResultConsumptionOn.productionReleaseCrpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateCrpFulfillCalled ===
        false,
  ...
  assert.equal(
    summary.crpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateInactiveUntilReceiptDecodePreflightReady,
    true,
  );
  assert.equal(
    summary.crpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateObservedAfterReceiptDecodePreflight,
    true,
  );
  assert.equal(
    summary.crpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGatePreservesPreflightAndHandlingGateContext,
    true,
  );
  assert.equal(
    summary.crpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateRecordsDecodeRequirements,
    true,
  );
  assert.equal(
    summary.crpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateDoesNotObserveReceiptMaterial,
    true,
  );
  assert.equal(
    summary.crpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateDoesNotHandleOrConsumeReceiptMaterial,
    true,
  );
  assert.equal(
    summary.crpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateDoesNotDecodeOrParseReceipt,
    true,
  );
  assert.equal(
    summary.crpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateDoesNotVerifySettlementOrTuple,
    true,
  );
  assert.equal(
    summary.crpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateDoesNotTouchReplay,
    true,
  );
  assert.equal(
    summary.crpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateDoesNotAuthorizeProductionRelease,
    true,
  );
  assert.equal(
    summary.crpFulfillClientAdapterResultConsumptionReceiptDecodeHandlingGateSideEffectFree,
    true,
  );
