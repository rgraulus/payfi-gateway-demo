#!/usr/bin/env node
/**
 * PR #194 — Phase 3 production release CRP fulfill client adapter dry-run invocation boundary.
 *
...
const LABEL = "phase3:production-release-crp-fulfill-client-adapter-dry-run-invocation-test";

const SWITCH_OFF_GATEWAY_PORT = Number(process.env.PHASE3_PROD_CRP_FULFILL_CLIENT_ADAPTER_DRY_RUN_INVOCATION_OFF_PORT || 3112);
const SWITCH_OFF_JWKS_PORT = Number(process.env.PHASE3_PROD_CRP_FULFILL_CLIENT_ADAPTER_DRY_RUN_INVOCATION_OFF_JWKS_PORT || 8122);

const SWITCH_ON_GATEWAY_PORT = Number(process.env.PHASE3_PROD_CRP_FULFILL_CLIENT_ADAPTER_DRY_RUN_INVOCATION_ON_PORT || 3113);
const SWITCH_ON_JWKS_PORT = Number(process.env.PHASE3_PROD_CRP_FULFILL_CLIENT_ADAPTER_DRY_RUN_INVOCATION_ON_JWKS_PORT || 8123);
...
async function main() {
  ...
  const summary = {
    ok: true,
    harness: "phase3.productionReleaseCrpFulfillClientAdapterDryRunInvocation.v1",
