#!/usr/bin/env node
/**
 * PR #185 — Phase 3 production release CRP fulfill request draft boundary.
 *
...
const LABEL = "phase3:production-release-crp-fulfill-request-draft-test";
...
async function main() {
  ...
  const summary = {
    ok: true,
    harness: "phase3.productionReleaseCrpFulfillRequestDraft.v1",
