#!/usr/bin/env node
/**
 * PR 4-1 — Phase 4 real CRP fulfill invocation boundary.
 *
 * Controlled invocation boundary checkpoint.
 *
 * This validates the Phase 4 boundary with controlled CRP fulfill invocation:
...
const LABEL = "phase4:real-crp-fulfill-invocation-boundary-test";
const GATEWAY_PORT = Number(process.env.PHASE4_REAL_CRP_FULFILL_INVOCATION_BOUNDARY_PORT || 3124);
const CRP_PORT = Number(process.env.PHASE4_REAL_CRP_FULFILL_INVOCATION_BOUNDARY_CRP_PORT || 8124);
